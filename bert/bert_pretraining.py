"""
Original code from https://github.com/huggingface/transformers/edit/main/examples/flax/language-modeling/run_mlm_flax.py
...
def main():
    ...
    # Get the datasets: you should provide your own CSV/JSON/TXT training and evaluation files (see below)
    #
    # For CSV/JSON files, this script will use the column called 'content' or the first column if no column called
    # 'content' is found. You can easily tweak this behavior (see below).
    #
